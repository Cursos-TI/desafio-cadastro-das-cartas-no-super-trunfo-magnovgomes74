...
int main(){
    ...
    // Lendo os dados das cartas 1 e 2:
    printf("Carta 1\n");
    ...
    // Calculando a densidade populacional das cartas 1 e 2:
    ...
    // Comparando o primeiro atributo do jogo;
    switch (atributo1) {
    ...
    printf("\nO valor do primeiro atributo escolhido para a carta 1: %.2f\n", valor1);
